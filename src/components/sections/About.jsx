        ...
        <div className="max-w-5xl mx-auto px-4 w-full space-y-16">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 hover:shadow-md transition bg-[#FFDEDE]">
                <h4 className="text-xl font-bold mb-2 text-[#4e342e]">
                  Bachelor in Computer Application (TU)
                </h4>
                <ul className="list-disc list-inside text-[#4e342e] ml-2 space-y-2">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 hover:shadow-md transition bg-[#FFDEDE]">
                <h4 className="text-xl font-bold mb-2 text-[#4e342e]">
                  PHP Developer - InnovateX (2021)
                </h4>
                <ul className="list-disc list-inside text-[#4e342e] ml-2 space-y-2">
                  <li>
                    Developed and maintained backend features using core PHP and
                    MySQL.
                  </li>
                  <li>
                    Worked on open source software projects, contributing to
                    code improvement, customization, and feature enhancement.
                  </li>
                </ul>
                {/* <div className="mt-4">
                  <a
              ...
              <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 hover:shadow-md transition bg-[#FFDEDE]">
                <h4 className="text-xl font-bold mb-2 text-[#4e342e]">
                  React Developer – Icon Soft (2025)
                </h4>
                <ul className="list-disc list-inside text-[#4e342e] ml-2 space-y-2">
                  <li>
                    Developing and maintaining scalable, responsive web
                    applications using React.js and JavaScript (ES6+).
                  </li>
                  <li>
                    Building reusable components and frontend libraries for
                    future use.
                  </li>
                  <li>
                    Implementing state management using Redux, ReduxTookit or
                    Context API as per project requirements.
                  </li>
                  <li>
